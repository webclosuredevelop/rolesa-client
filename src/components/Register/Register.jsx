    ...
    return (
        <>
            ...
            <div className="main-header">
                ...
                <img className="img-bottom" src="/assets/img/account-bottom.webp" width="1169" height="153" />
            </div>
                ...
                <div className="row">
                    <div className="col col-xl-9 order-xl-2 col-lg-9 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
                        ...
                        <div className="tab-content" id="myTabContent">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div className="form-group label-floating">
                                                        ...
                                                        <input value={name} onChange={(e) => setName(e.target.value)}  className="form-control" placeholder="" type="text" defaultValue="James" />
                                                    </div>
                                                    ...
                                                    <div className="form-group date-time-picker label-floating">
                                                        ...
                                                        <input value={birthday} onChange={(e) => setBirthday(e.target.value)}  name="dateTimepicker" defaultValue="10/24/1984" />
                                                ...
                                                <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div className="form-group label-floating">
                                                        ...
                                                        <input value={surname} onChange={(e) => setSurname(e.target.value)}  className="form-control" placeholder="" type="text" defaultValue="Spiegel" />
                                                    </div>

                                                    <div className="form-group label-floating">
                                                        <label className="control-label">Your Website</label>
                                                        <input value={website} onChange={(e) => setWebsite(e.target.value)}  className="form-control" placeholder="" type="email"
                                                    ...
                                                    <div className="form-group label-floating is-empty">
                                                        ...
                                                        <input value={phone} onChange={(e) => setPhone(e.target.value)}  className="form-control" placeholder="" type="text" />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                    ...
                                                    <div className="form-group label-floating is-empty">
                                                        ...
                                                        <input value={religion} onChange={(e) => setReligion(e.target.value)}  className="form-control" placeholder="" type="text" />
                                                    </div>
                                                </div>
                                                <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div className="form-group label-floating is-empty">
                                                        <label className="control-label">Your Birthplace</label>
                                                        <input  value={birthplace} onChange={(e) => setBirthplace(e.target.value)}  className="form-control" placeholder="" type="text" />
                                                    </div>

                                                    <div className="form-group label-floating">
                                                        <label className="control-label">Your Occupation</label>
                                                        <input  value={work} onChange={(e) => setWork(e.target.value)}  className="form-control" placeholder="" type="text"
                                                    ...
                                                    <div className="form-group label-floating">
                                                        ...
                                                        <input value={politic} onChange={(e) => setPolitic(e.target.value)}  className="form-control" placeholder="" type="text" defaultValue="Democrat" />
                                                    </div>
                                                </div>
                                                <div className="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <div className="form-group with-icon label-floating">
                                                        <label className="control-label">Your Facebook Account</label>
                                                        <input value={facebook} onChange={(e) => setFacebook(e.target.value)}  className="form-control" type="text"
                                                    ...
                                                    <div className="form-group with-icon label-floating">
                                                        ...
                                                        <input  value={twitter} onChange={(e) => setTwitter(e.target.value)}  className="form-control" type="text"
                                                    ...
                                                    <div className="form-group with-icon label-floating is-empty">
                                                        ...
                                                        <input  value={rss} onChange={(e) => setRss(e.target.value)}  className="form-control" type="text" />
                                                    ...
                                                    <div className="form-group with-icon label-floating">
                                                        ...
                                                        <input  value={dribble} onChange={(e) => setDribble(e.target.value)}  className="form-control" type="text"
                                                    ...
                                                    <div className="form-group with-icon label-floating is-empty">
                                                        ...
                                                        <input value={spotify} onChange={(e) => setSpotify(e.target.value)}  className="form-control" type="text" />
                                                ...
                                                <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <button className="btn btn-secondary btn-lg full-width">Restore all
                                                        Attributes</button>
                                                </div>
                                                <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                ...
                                                <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div className="form-group label-floating is-select">
                                                        ...
                                                        <select className="form-select">
                                                            <option defaultValue="EO">Everyone</option>
                                                            <option defaultValue="NO">No One</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div className="form-group label-floating is-select">
                                                        ...
                                                        <select className="form-select">
                                                            <option defaultValue="US">Friends Only</option>
                                                            <option defaultValue="EO">Everyone</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div className="description-toggle">
                                                        <div className="description-toggle-content">
                                                            ...
                                                            <p>We’ll send you an email to your account each time you receive a
                                                                new activity notification</p>
                                                        </div>
                                                    ...
                                                    <div className="description-toggle">
                                                        <div className="description-toggle-content">
                                                            ...
                                                            <p>A sound will be played each time you receive a new message on an
                                                                inactive chat window</p>
                                                        </div>
                                    ...
                                    <div className="ui-block-content">
                                        ...
                                        <form>
                                            <div className="row">
                                                ...
                                                <div className="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <button className="btn btn-primary btn-lg full-width">Change Password
                                                        Now!</button>
                                                </div>
                            ...
                            <div className="tab-pane fade" id="hobbies" role="tabpanel" aria-labelledby="hobbies-tab">
                                <div className="ui-block">
                                    <div className="ui-block-title">
                                        ...
                                        <form>
                                            <div className="row">
                                                ...
                                                <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div className="form-group">
                                                        <textarea className="form-control"
                                                            placeholder="Hobbies">I like to ride the bike to work, swimming, and working out. I also like reading design magazines, go to museums, and binge watching a good tv show while it’s raining outside.</textarea>
                                                    </div>
                                                    <div className="form-group">
                                                        <textarea className="form-control"
                                                            placeholder="Favourite TV Shows">Breaking Good, RedDevil, People of Interest, The Running Dead, Found,  American Guy.</textarea>
                                                    </div>
                                                    <div className="form-group">
                                                        <textarea className="form-control"
                                                            placeholder="Favourite Movies">Idiocratic, The Scarred Wizard and the Fire Crown,  Crime Squad, Ferrum Man. </textarea>
                                                    </div>
                                                    <div className="form-group">
                                                        <textarea className="form-control"
                                                            placeholder="Favourite Games">The First of Us, Assassin’s Squad, Dark Assylum, NMAK16, Last Cause 4, Grand Snatch Auto. </textarea>
                                                    </div>
                                                ...
                                                <div className="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div className="form-group">
                                                        <textarea className="form-control"
                                                            placeholder="Favourite Music Bands / Artists">Iron Maid, DC/AC, Megablow, The Ill, Kung Fighters, System of a Revenge.</textarea>
                                                    </div>
                                                    <div className="form-group">
                                                        <textarea className="form-control"
                                                            placeholder="Favourite Books">The Crime of the Century, Egiptian Mythology 101, The Scarred Wizard, Lord of the Wings, Amongst Gods, The Oracle, A Tale of Air and Water.</textarea>
                                                    </div>
                                                    <div className="form-group">
                                                        <textarea className="form-control"
                                                            placeholder="Favourite Writers">Martin T. Georgeston, Jhonathan R. Token, Ivana Rowle, Alexandria Platt, Marcus Roth. </textarea>
                                                    </div>
                                                    <div className="form-group">
                                                        <textarea className="form-control"
                                                            placeholder="Other Interests">Swimming, Surfing, Scuba Diving, Anime, Photography, Tattoos, Street Art.</textarea>
                                                    </div>
                    ...
                    <div id="desktop-container-panel"
                        className="col col-xl-3 order-xl-1 col-lg-3 order-lg-1 col-md-12 order-md-2 col-sm-12 col-12 responsive-display-none">
                        <div className="ui-block">
